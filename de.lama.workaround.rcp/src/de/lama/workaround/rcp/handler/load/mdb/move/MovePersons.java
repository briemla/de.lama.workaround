...
import static de.lama.workaround.rcp.handler.load.mdb.move.extractor.DBKonstanten.TBL_PERSON;
...
import de.lama.workaround.rcp.handler.load.mdb.move.extractor.Extract;
import de.lama.workaround.rcp.handler.load.mdb.move.extractor.IExtractStrategie;
import de.lama.workaround.rcp.handler.load.mdb.move.extractor.PersonExtractStrategie;
