...
public class WorkaroundEditingDomain extends AdapterFactoryEditingDomain
{
    ...
    public WorkaroundEditingDomain(ComposedAdapterFactory adapterFactory, BasicCommandStack commandStack, HashMap<Resource, Boolean> hashMap)
    {
