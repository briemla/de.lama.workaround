...
/**
 * This is an example of a Workaround model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class WorkaroundEditor extends MultiPageEditorPart implements
	 ...
	 * @generated
	 */
	public static final List FILE_EXTENSION_FILTERS = prefixExtensions(
			WorkaroundModelWizard.FILE_EXTENSIONS, "*.");
	...
	protected void updateProblemIndication() {
		if (updateProblemIndication) {
			BasicDiagnostic diagnostic = new BasicDiagnostic(Diagnostic.OK,
					"de.lama.workaround.model.editor", 0, null,
	...
	protected void initializeEditingDomain() {
		...
		adapterFactory
				.addAdapterFactory(new WorkaroundItemProviderAdapterFactory());
		adapterFactory
		...
		//
		editingDomain = new WorkaroundEditingDomain(adapterFactory,
	...
	public Diagnostic analyzeResourceProblems(Resource resource,
		...
		if (!resource.getErrors().isEmpty()
			...
			return new BasicDiagnostic(Diagnostic.ERROR,
					"de.lama.workaround.model.editor", 0, getString(
	...
	public void doSaveAs() {
		String[] filters = (String[]) FILE_EXTENSION_FILTERS
				.toArray(new String[FILE_EXTENSION_FILTERS.size()]);
		String[] files = WorkaroundEditorAdvisor.openFilePathDialog(getSite()
