...
public class WorkaroundPackageImpl extends EPackageImpl implements WorkaroundPackage
{
     ...
     * @generated
     */
    public EReference getWorkaround_OperationList()
    {
    ...
    public void createPackageContents()
    {
        ...
        createEReference(workaroundEClass, WORKAROUND__OPERATION_LIST);
    ...
    public void initializePackageContents()
    {
        ...
        initEReference(getWorkaround_OperationList(), this.getOperation(), null, "operationList", null, 0, -1, Workaround.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
