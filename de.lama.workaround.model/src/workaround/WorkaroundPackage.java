...
public interface WorkaroundPackage extends EPackage
{
     ...
     * @ordered
     */
    int WORKAROUND__OPERATION_LIST = 0;
    ...
    /**
     * Returns the meta object for the containment reference list '{@link workaround.Workaround#getOperationList <em>Operation List</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the containment reference list '<em>Operation List</em>'.
     * @see workaround.Workaround#getOperationList()
     * @see #getWorkaround()
     * @generated
     */
    EReference getWorkaround_OperationList();
    ...
    interface Literals
    {
         ...
         * @generated
         */
        EReference WORKAROUND__OPERATION_LIST = eINSTANCE.getWorkaround_OperationList();
